...
- The API endpoints in this project are a web interface to the [VoteTrackerPlus backend](https://github.com/OpenVotingTechnologyGroup/VoteTrackerPlus).
...
To include the python backend, in another terminal window configure the VoteTrackerPlus repo and perform a local installation of the ElectionData repo.  See the [README](https://github.com/OpenVotingTechnologyGroup/VoteTrackerPlus) for more info.
